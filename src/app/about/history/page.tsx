...
export default function HistoryPage() {
  ...
  const timelineEvents = {
    ...
    barbados: [
      ...
      {
        year: "1884",
        title: "First Adventist Missionaries Reach Barbados",
        description: "The first Seventh-day Adventist missionaries arrived in Barbados, bringing the Adventist message to the island.",
        location: "Bridgetown, Barbados",
        significance: "Adventist faith introduced to Barbados"
      },
      {
        year: "1914",
        title: "First Adventist Church Established in Barbados",
        description: "The first formal Seventh-day Adventist congregation was established in Bridgetown, marking the beginning of organized Adventist work on the island.",
        location: "Bridgetown, Barbados",
        significance: "First Adventist church in Barbados"
      },
      {
        year: "1955",
        title: "Barbados Conference Organized",
        description: "The Barbados Conference of Seventh-day Adventists was officially organized, providing structure for Adventist work across the island.",
        location: "Barbados",
        significance: "Organized conference structure established"
      },
      {
        year: "1982",
        title: "ANYA Barbados Founded",
        description: "The Adventist National Youth Association was established in Barbados to coordinate and empower youth ministries across the island's Adventist community.",
        location: "Bridgetown, Barbados",
        significance: "ANYA Barbados begins youth unification"
      },
      {
        year: "1990s",
        title: "Expansion Across Parishes",
        description: "ANYA expanded its reach to all 11 parishes of Barbados, establishing youth ministries in churches across the island.",
        location: "Throughout Barbados",
        significance: "Island-wide youth ministry coverage"
      },
      {
        year: "2005",
        title: "First National Youth Convention",
        description: "ANYA Barbados hosted its first national youth convention, bringing together hundreds of Adventist youth from across the island.",
        location: "Bridgetown, Barbados",
        significance: "Large-scale youth gathering established"
      },
      {
        year: "2015",
        title: "Digital Ministry Initiative",
        description: "ANYA Barbados launched digital ministry platforms to connect with youth through social media and online content.",
        location: "Barbados",
        significance: "Modern digital outreach begins"
      },
      {
        year: "2020",
        title: "45 Churches United Under ANYA",
        description: "ANYA reached a milestone of coordinating youth ministries across 45 Seventh-day Adventist churches throughout Barbados.",
        location: "Barbados",
        significance: "Comprehensive church network achieved"
      },
      {
        year: "Today",
        title: "Thriving Youth Ministry",
        description: "ANYA Barbados continues to grow and innovate, empowering Adventist youth across the island through dynamic programs and leadership development.",
        location: "Across Barbados",
        significance: "Ongoing growth and innovation"
      }
    ]
  };
    ...
    barbados: [
      {
        number: "45+",
        label: "Churches United",
        description: "Adventist congregations across Barbados"
      },
      {
        number: "40+",
        label: "Years of Service",
        description: "Serving Adventist youth in Barbados"
      },
      {
        number: "3000+",
        label: "Youth Impacted",
      ...
      },
      {
        ...
        description: "Covering every parish in Barbados"
      }
    ]
  };
  ...
  const foundingPrinciples = {
    ...
    barbados: [
      {
        title: "Youth Empowerment",
        description: "Developing young Adventist leaders with skills for ministry and community impact.",
        icon: "🎯"
      },
      {
        title: "National Unity",
        description: "Uniting Adventist youth from all 11 parishes of Barbados under one vision.",
        icon: "🤝"
      },
      {
        title: "Cultural Relevance",
        description: "Adapting ministry approaches to connect with Barbadian youth culture while maintaining biblical foundations.",
        icon: "🏝️"
      },
      {
        title: "Innovation & Excellence",
        description: "Embracing new methods and striving for excellence in all youth ministry initiatives.",
        icon: "✨"
      }
    ]
  };
  ...
  const countryInfo = {
    dominica: {
      name: "Dominica",
      title: "ANYA Dominica • Since 1978",
      foundingYear: "1978",
      foundingDescription: "In 1978, a group of visionary Adventist leaders in Dominica recognized the need for coordinated youth ministry across the island. Young people were the future of the church, but their potential was limited by geographical isolation and fragmented resources.",
      foundingLocation: "Roseau, Dominica",
      heroDescription: "From humble beginnings to island-wide impact. The story of how ANYA united 90 Adventist churches across Dominica through faith, vision, and perseverance.",
      principlesTitle: "Enduring Principles",
      principlesDescription: "The core values that have guided ANYA Dominica since the beginning",
      legacyTitle: "Our Lasting Impact",
      callToAction: "Join the next chapter of ANYA's history as we continue to empower Adventist youth and serve communities across Dominica."
    },
    barbados: {
      name: "Barbados",
      title: "ANYA Barbados • Since 1982",
      foundingYear: "1982",
      foundingDescription: "In 1982, Adventist leaders in Barbados saw the need for a unified youth organization that could bring together young people from across the island's 11 parishes. ANYA Barbados was founded to create a strong network for youth development, spiritual growth, and community impact.",
      foundingLocation: "Bridgetown, Barbados",
      heroDescription: "From Bridgetown beginnings to national impact. The story of how ANYA united 45 Adventist churches across Barbados through faith, innovation, and dedicated service.",
      principlesTitle: "Guiding Principles",
      principlesDescription: "The core values that have guided ANYA Barbados since its founding",
      legacyTitle: "Our National Impact",
      callToAction: "Join the next chapter of ANYA's history as we continue to empower Adventist youth and serve communities across Barbados."
    }
  };

  const currentCountry = countryInfo[selectedCountry];
  const currentTimeline = timelineEvents[selectedCountry];
  const currentMilestones = keyMilestones[selectedCountry];
  const currentPrinciples = foundingPrinciples[selectedCountry];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50">
      ...
      <section className="relative py-20! bg-gradient-to-r from-blue-700 to-purple-800 text-white">
        <div className="container mx-auto! px-4! max-w-6xl">
          <div className="text-center">
            ...
            <h1 className="text-5xl font-bold mb-6!">Our History - {currentCountry.name}</h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto! leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-8! shadow-lg border border-gray-200">
            <div className="grid md:grid-cols-2 gap-8! items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4!">The ANYA Vision Begins</h3>
                <p className="text-gray-700 leading-relaxed mb-4!">
                  {currentCountry.foundingDescription}
                </p>
                <p className="text-gray-700 leading-relaxed">
                  ANYA was born from this vision—to create a unified network that would empower 
                  Adventist youth, develop their leadership potential, and mobilize them for 
                  service across all churches in {currentCountry.name}.
                </p>
              </div>
              <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl p-6! text-center">
                <div className="text-6xl mb-4!">{selectedCountry === 'dominica' ? '🏝️' : '🏖️'}</div>
                <h4 className="font-bold text-gray-900 text-lg mb-2!">{currentCountry.name} Roots</h4>
                <p className="text-gray-600 text-sm">
                  Founded in {currentCountry.foundingLocation} with a mission to serve every Adventist young person across our beautiful island
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16! bg-white">
        <div className="container mx-auto! px-4! max-w-6xl">
          <div className="text-center mb-12!">
            <h2 className="text-3xl font-bold text-gray-900 mb-4!">Our Journey Through Time</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto!">
              From global Adventist beginnings to local {selectedCountry === 'dominica' ? 'Dominican' : 'Barbadian'} impact
            </p>
          </div>
      ...
      <section className="py-16! bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="container mx-auto! px-4! max-w-6xl">
          <div className="text-center mb-12!">
            <h2 className="text-3xl font-bold mb-4!">{currentCountry.principlesTitle}</h2>
            <p className="text-xl text-blue-100 max-w-2xl mx-auto!">
              {currentCountry.principlesDescription}
            </p>
          </div>
      ...
      <section className="py-16! bg-white">
        <div className="container mx-auto! px-4! max-w-4xl">
          <div className="text-center mb-12!">
            <h2 className="text-3xl font-bold text-gray-900 mb-4!">{currentCountry.legacyTitle}</h2>
            <div className="w-24 h-1 bg-blue-600 mx-auto mb-6!"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8!">
            <div className="bg-blue-50 rounded-2xl p-6!">
              <h3 className="text-xl font-bold text-gray-900 mb-4!">🚀 Youth Leadership Development</h3>
              <p className="text-gray-700 mb-4!">
                ANYA has trained generations of Adventist leaders who now serve across {currentCountry.name} 
                and around the world—pastors, teachers, healthcare professionals, and community leaders.
              </p>
              <ul className="space-y-2! text-gray-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mr-3!"></div>
                  Leadership training programs since {currentCountry.foundingYear}
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mr-3!"></div>
                  Mentorship across {selectedCountry === 'dominica' ? '10 regions' : '11 parishes'}
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mr-3!"></div>
                  Global network of ANYA alumni
            ...
            <div className="bg-green-50 rounded-2xl p-6!">
              ...
              <p className="text-gray-700 mb-4!">
                Through disaster response, health initiatives, and ongoing service projects, 
                ANYA has demonstrated practical Christianity across {selectedCountry === 'dominica' ? 'Dominican' : 'Barbadian'} communities.
              </p>
              <ul className="space-y-2! text-gray-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-3!"></div>
                  {selectedCountry === 'dominica' ? 'Hurricane Maria relief coordination' : 'Community health and wellness programs'}
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-3!"></div>
                  Annual community service projects
        ...
        <div className="container mx-auto! px-4! max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8! text-center">
            ...
            <div className="bg-green-50 rounded-2xl p-6!">
              ...
              <h3 className="font-bold text-gray-900 mb-3!">Oral Histories</h3>
              <p className="text-gray-600 mb-4! text-sm">Watch interviews with ANYA founders and early members</p>
              <Link href="#" className="text-green-600 hover:text-green-700 font-semibold text-sm">
                Watch Stories →
              </Link>
            </div>
            ...
            <div className="bg-purple-50 rounded-2xl p-6!">
              <div className="text-3xl mb-4!">📊</div>
              <h3 className="font-bold text-gray-900 mb-3!">Growth Timeline</h3>
              <p className="text-gray-600 mb-4! text-sm">See how ANYA and Adventist churches have grown in {currentCountry.name}</p>
