  ...
  const ArticleCard = ({ article }: { article: Article }) => (
    <div className={`bg-white! rounded-lg! shadow-sm! border! ${article.featured ? 'border-blue-300! ring-1! ring-blue-200!' : 'border-gray-200!'} p-6! hover:shadow-md! transition-all! duration-200!`}>
      ...
      <div className="flex! gap-x-3!">
        ...
        className="flex-1! bg-blue-600! text-white! py-2! px-4! rounded-lg! font-medium! hover:bg-blue-700! transition-colors! duration-200! focus:outline-none! focus:ring-2! focus:ring-blue-500! focus:ring-offset-2! text-center!"
      >
        Read Article
      </Link>
